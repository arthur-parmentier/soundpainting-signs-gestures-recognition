...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 938.0, 332.0, 50.0, 202.0 ],
					"presentation_linecount" : 14,
					"text" : "-157.237153 298.532599 -193.69 136.206116 -199.67 134.362589 432.245061 158.805823"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "-0.535231 1.452179 -0.659315 0.662559 -0.679671 0.653592 1.47135 0.772493"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2138.0, 1310.0, 68.0, 22.0 ],
					"text" : "r #0models"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1071.833333333333258, 1724.0, 67.0, 22.0 ],
					"text" : "cleartracks"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1020.0, 1752.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1020.0, 1783.0, 35.0, 22.0 ],
					"text" : "set 0"
				}
...
,
					"patching_rect" : [ 945.0, 1783.0, 64.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 945.0, 1752.0, 68.0, 22.0 ],
					"text" : "r #0models"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-36",
					"items" : [ "full_body_DTW", ",", "hands_adaboost" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 945.0, 1815.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 2070.0, 91.0, 22.0 ],
					"text" : "full_body_DTW"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 255.0, 2100.0, 207.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 2130.0, 82.0, 22.0 ],
					"text" : "prepend send"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1709.200000000000045, 1695.0, 101.0, 22.0 ],
...
,
					"patching_rect" : [ 1602.0, 1665.0, 555.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1071.833333333333258, 1755.0, 71.0, 22.0 ],
					"text" : "clearbuffers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1602.0, 1310.0, 86.0, 22.0 ],
					"text" : "r #0new_signs"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 1602.0, 1343.0, 555.0, 313.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 767.0, 661.0, 91.0, 22.0 ],
					"text" : "s #0input_sizes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 661.0, 63.0, 22.0 ],
					"text" : "s #0inputs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 2160.0, 49.0, 22.0 ],
					"text" : "forward"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 615.0, 1335.0, 976.0, 365.0 ],
