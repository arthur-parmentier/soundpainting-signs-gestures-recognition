...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 705.0, 90.0, 150.256981730461121, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 705.0, 90.0, 150.256981730461121, 40.0 ],
					"text" : "Current state"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 150.0, 210.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.0, 150.0, 210.0, 25.0 ],
					"text" : "Reload the graph html page"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1290.0, 35.756404191255569, 36.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1290.0, 35.756404191255569, 36.0, 22.0 ],
					"text" : "defer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 15.0, -75.0, 88.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, -75.0, 88.0, 22.0 ],
					"text" : "loadpercent 30"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 90.0, 150.256981730461121, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 90.0, 150.256981730461121, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1335.0, 35.756404191255569, 128.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1335.0, 35.756404191255569, 128.0, 22.0 ],
...
,
					"patching_rect" : [ 180.0, -45.0, 95.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.0, -45.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 120.0, 915.0, 57.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 285.0, 120.0, 915.0, 57.0 ],
					"text" : "Start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1290.0, 75.0, 69.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1290.0, 75.0, 69.0, 22.0 ],
					"text" : "route /state"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1290.0, -30.0, 133.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1290.0, -30.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 0.0, -105.0, 88.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, -105.0, 88.0, 22.0 ],
					"text" : "loadpercent 50"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 180.0, -75.0, 73.0, 22.0 ],
					"text" : "route /graph"
				}
...
,
					"patching_rect" : [ 15.0, -45.0, 158.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 15.0, -45.0, 158.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 150.0, 42.0, 22.0 ],
					"text" : "reload"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 90.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 15.0, 120.0, 64.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1290.0, 5.756404191255569, 236.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1290.0, 5.756404191255569, 236.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 0,
						"defer" : 0,
						"node_bin_path" : "",
