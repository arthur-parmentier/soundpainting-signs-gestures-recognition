...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "right wrist normalize heigth (fader value)",
					"id" : "obj-33",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 945.0, 810.0, 29.5, 22.0 ],
					"text" : "/ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 990.0, 810.0, 345.0, 34.0 ],
					"text" : "fader value = (Y_right_hip - Y_right_wrist)/(Y_right_hip - Y_right_shoulder)*2"
				}
